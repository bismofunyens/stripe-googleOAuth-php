...
<body>
    <nav class="iconav">
        ...
        <div class="iconav-slider">
          ...
          <li>
              <a href="index.php" title="Home" data-toggle="tooltip" data-placement="right" data-container="body">
                <span class="icon icon-home"></span>
                <small class="iconav-nav-label visible-xs-block">Home</small>
              </a>
            </li>
            <li class="active">
  ...
  <div class="dashhead-titles">
    ...
    <h2 class="dashhead-title">Transaction History</h2>
  </div>
...
<div class="btn-group" role="group">
    ...
    <a href="transactions.php" class="btn btn-primary active">Transactions</a>
</div>
